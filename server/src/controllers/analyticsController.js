...
const getAnalyticsSummary = async (req, res) => {
  try {
    ...
    // Uses the time between the first and latest created orders.
    ...
    //
    // For PLACED:
    // orders.created_at -> first status change.
    //
    // For other stages:
    ...
    // The bottleneck is the stage with the highest average time.
    let bottleneck = null;
